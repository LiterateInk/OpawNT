...
suspend fun conversationTrash(auth: Authentication, ids: List<String>) {
    val request = Request("/conversation/trash")
...
suspend fun conversationTrash(auth: Authentication, id: String) {
    val request = Request("/conversation/trash")
    request.useAuthentication(auth)
    request.setJSON(
        buildJsonObject {
